...
@safe: class DBS4Obj : DH5Obj {
	...
	unittest {
		assert(Assert(BS4Obj.margin("t-2"), `<div class="mt-2"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.border, `<div class="border"></div>`));
		assert(Assert(BS4Obj.border(1), `<div class="border-1"></div>`));
		assert(Assert(BS4Obj.border("top"), `<div class="border-top"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.noBorder, `<div class="border-0"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.borderColor("primary"), `<div class="border-primary"></div>`));
		assert(Assert(BS4Obj.border.borderColor("primary"), `<div class="border border-primary"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.rounded, `<div class="rounded"></div>`));
		assert(Assert(BS4Obj.rounded("top"), `<div class="rounded-top"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.noRounded, `<div class="rounded-0"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.roundedSize("lg"), `<div class="rounded-lg"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.clearfix, `<div class="clearfix"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.closeButton, `<div><button class="btn close" aria-label="Close" type="button"><span aria-label="true">&times;</span></button></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.textColor("primary"), `<div class="text-primary"></div>`));
		assert(Assert(BS4Obj.textColor("black", "50"), `<div class="text-black-50"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.background("primary"), `<div class="bg-primary"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.display("none"), `<div class="d-none"></div>`));
		assert(Assert(BS4Obj.display("sm", "block"), `<div class="d-sm-block"></div>`));
	}
	...
	unittest {
		assert(Assert(BS4Obj.print("none"), `<div class="d-print-none"></div>`));
	}
}
