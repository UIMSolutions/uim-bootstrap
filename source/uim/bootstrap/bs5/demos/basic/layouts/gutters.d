...
static this() {
	demoBS5.pages("basic/layouts/gutters", new class DH5AppPage {
		this() { 
			super(); 
			this
...
H5Main(["style":"margin-top:70px;"], 
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-bootstrap", "Bootstrap 5", "Basic", "Layouts"], "Gutters")),

  BS5Container(["mt-3"]).row(
    H5Div(["col-12", "col-lg-2"], 
      listLevels("basic"),
      listAreas("basic", "layouts"),
      listSections("basic", "layouts", "gutters")),
    H5Div(["col-12", "col-lg-8"], 
        ...
        H5Div(
          BS5Container(
            BS5Row(["gx-0"], 
              ...
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")))),
          H5H5(["text-muted", "mt-3", "container"], "1"),
          BS5Container(  
            BS5Row(["gx-1"],
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")),
              ...
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")))),
          H5H5(["text-muted", "mt-3", "container"], "2"),
          BS5Container(  
            BS5Row(["gx-2"], 
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")),
              ...
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")))),
          H5H5(["text-muted", "mt-3", "container"], "3"),
          BS5Container(  
            BS5Row(["gx-3"], 
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")),
              ...
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")))),
          H5H5(["text-muted", "mt-3", "container"], "4"),
          BS5Container(  
            BS5Row(["gx-4"], 
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")),
              ...
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")))),
          H5H5(["text-muted", "mt-3", "container"], "5"),
          BS5Container(  
            BS5Row(["gx-5"],
              H5Div(["col-3"], 
                H5Div(["p-3 border bg-light"], "Column")),
      ...
      demoBs5Example("responsive", "Responsive",
        ...
        demoBs5Example("vertical", "Vertical",
          H5Div(
            H5H5(["text-muted", "mt-3", "container"], "0"),
            BS5Container(
              BS5Row(["gy-0"], 
                H5Div(["col-12"], 
                  H5Div(["p-3 border bg-light"], "Column")),
