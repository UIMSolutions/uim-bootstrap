      ...
      BS5ModalDialog(["modal-fullscreen"], ["role":"document"], 
        BS5ModalContent(
          ...
          BS5ModalFooter(
            BS5Button(["btn-primary"], "Action"),
            BS5Button(["btn-secondary"], ["data-dismiss":"modal"], "Close"))))),
    H5H5(["text-muted", "mt-3"], "Below small"),
      ...
      BS5ModalDialog(["modal-fullscreen-sm-down"], ["role":"document"], 
        BS5ModalContent(
          ...
          BS5ModalFooter(
            BS5Button(["btn-primary"], "Action"),
            BS5Button(["btn-secondary"], ["data-dismiss":"modal"], "Close"))))),
    H5H5(["text-muted", "mt-3"], "Below medium"),
        ...
        BS5ModalDialog(["modal-fullscreen-md-down"], ["role":"document"], 
          BS5ModalContent(
            ...
            BS5ModalFooter(
              BS5Button(["btn-primary"], "Action"),
              BS5Button(["btn-secondary"], ["data-dismiss":"modal"], "Close"))))),
    H5H5(["text-muted", "mt-3"], "Below large"),
      ...
      BS5ModalDialog(["modal-fullscreen-lg-down"], ["role":"document"], 
        BS5ModalContent(
          ...
          BS5ModalFooter(
            BS5Button(["btn-primary"], "Action"),
            BS5Button(["btn-secondary"], ["data-dismiss":"modal"], "Close"))))), 
    H5H5(["text-muted", "mt-3"], "Below extra large"),
      ...
      BS5ModalDialog(["modal-fullscreen-xl-down"], 
        BS5ModalContent(
          ...
          BS5ModalFooter(
            BS5Button(["btn-primary"], "Action"),
            BS5Button(["btn-secondary"], ["data-dismiss":"modal"], "Close"))))),
    H5H5(["text-muted", "mt-3"], "Below extra extra large"),
