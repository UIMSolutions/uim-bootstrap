...
static this() {
	demoBS5.pages("basic/components/buttons", new class DH5AppPage {
		this() { 
			super(); 
			this
...
auto blockExample = demoBs5Example("block", "Block", 
  H5Div(
    H5H5(["text-muted", "mt-3"], "Full width using sizing utility"), 
    BS5Button(["btn-secondary", "w-100"], "Block button"), 
    H5H5(["text-muted", "mt-3"], "Full width using display utility"),
    H5Div(["d-grid"], 
      BS5Button(["btn-secondary"], "Block button")),
    H5H5(["text-muted", "mt-3"], "Column width"), 
    H5Div(["d-grid", "col-6", "mx-auto"], 
      BS5Button(["btn-secondary"], "Block button")),
    H5H5(["text-muted", "mt-3"], "Multiple block buttons"), 
    H5Div(["d-grid", "gap-2"], 
      BS5Button(["btn-secondary"], "Block button"),
      BS5Button(["btn-secondary"], "Block button")),
...
auto pluginExample = demoBs5Example("plugin", "Button Plugin", 
  H5Div(
    H5H5(["text-muted", "mt-3"], "Toggle buttons"),
    ...
    H5H5(["text-muted", "mt-3"], "Toggle links"),
