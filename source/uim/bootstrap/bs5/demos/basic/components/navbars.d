...
auto formsExample = demoBs5Example("forms", "Navbar with Form",
  BS5Navbar(["navbar-light", "bg-light"], 
    BS5Container(
      BS5NavbarBrand(["href":"#"], "Navbar"),
      H5Form(
...
auto textExample = demoBs5Example("text", "Navbar with text",
  BS5Navbar(["navbar-light", "bg-light"], 
    BS5Container(
...
H5Main(["style":"margin-top:70px;"], 
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-bootstrap", "Bootstrap 5", "Basic", "Components"], "Navbars")),
