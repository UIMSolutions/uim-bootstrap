...
static this() {
	demoBS5.pages("basic/components/toasts", new class DH5AppPage {
		this() { 
			super(); 
			this
...
/* auto multipleExample = demoBs5Example("multiple", "Multiple",
  H5Div(
    ...
    H5H5(["text-muted", "mt-3"], "<a href="position-utilities.html"]Position</a> utilities")
    <iframe src="toasts/placement-position.html" "style":"width: 100%; height: 456px;"]</iframe>

    H5H5(["text-muted", "mt-3"], "<a href="flex.html"]Flex</a> utilities")
...
H5Main(["style":"margin-top:70px;"], 
  H5Div(["container-fluid", "mt-3", "bg-light"],
    ...
    ["UI Manufaktur", "Demos", "uim-bootstrap", "Bootstrap 5", "Basic", "Components"], "Toasts")),

  BS5Container(["mt-3"]).row(
    H5Div(["col-12", "col-lg-2"], 
      listLevels("basic"),
      listAreas("basic", "components"),
      listSections("basic", "components", "toasts")),
