...
<header>
  H5Div(["collapse bg-dark" id="navbarHeader">
    H5Div(["container">
      H5Div(["row">
        H5Div(["col-sm-8 col-md-7 py-4">
          H5H4(["text-white">About</h4>
  ...
  `H5Div(["album py-5 bg-light">
    H5Div(["container">
      ...
      H5Div(["row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        H5Div(["col">
          H5Div(["card shadow-sm">
            H5Svg(["bd-placeholder-img card-img-top" "width":"100%" "height":"225" xmlns="http://www.w3.org/2000/svg" "role":"img", "aria-label":"Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect "width":"100%" "height":"100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
...
<footer class="text-muted py-5">
  H5Div(["container">
    ...
    H5P(["mb-0">New to Bootstrap? H5A(["/">Visit the homepage"), or read our H5A(["../getting-started/introduction/">getting started guide"),.")
  ),
</footer>
`;
