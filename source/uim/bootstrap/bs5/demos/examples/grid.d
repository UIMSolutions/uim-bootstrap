...
<main>
  H5Div(["container">
    ...
    H5P("In these examples the <code>.themed-grid-col</code> class is added to the columns to add some theming. This is not a class that is available in Bootstrap by default.")
    ...
    H5P("Get three equal-width columns <strong>starting at desktops and scaling to large desktops"). On mobile devices, tablets and below, the columns will automatically stack.")
    H5Div(["row mb-3">
      H5Div(["col-md-4 themed-grid-col">.col-md-4),
      H5Div(["col-md-4 themed-grid-col">.col-md-4),
      H5Div(["col-md-4 themed-grid-col">.col-md-4),
    ...
    H5P("By using the <code>.row-cols-*</code> classes, you can easily create a grid with equal columns.")
    H5Div(["row row-cols-md-3 mb-3">
      H5Div(["col themed-grid-col"><code>.col</code> child of <code>.row-cols-md-3</code>),
      H5Div(["col themed-grid-col"><code>.col</code> child of <code>.row-cols-md-3</code>),
      H5Div(["col themed-grid-col"><code>.col</code> child of <code>.row-cols-md-3</code>),
    ),

    H5H2(["mt-4">Three unequal columns")
    H5P("Get three columns <strong>starting at desktops and scaling to large desktops") of various widths. Remember, grid columns should add up to twelve for a single horizontal block. More than that, and columns start stacking no matter the viewport.")
    H5Div(["row mb-3">
    ...
    H5H2(["mt-4">Gutters")
    H5P("With <code>.gx-*</code> classes, the horizontal gutters can be adjusted.")
    H5Div(["row row-cols-1 row-cols-md-3 gx-4">
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gx-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gx-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gx-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gx-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gx-4</code> gutters),
    ...
    H5P(["mt-4">Use the <code>.gy-*</code> classes to control the vertical gutters.")
    H5Div(["row row-cols-1 row-cols-md-3 gy-4">
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gy-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gy-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gy-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gy-4</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.gy-4</code> gutters),
    ...
    H5P(["mt-4">With <code>.g-*</code> classes, the gutters in both directions can be adjusted.")
    H5Div(["row row-cols-1 row-cols-md-3 g-3">
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.g-3</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.g-3</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.g-3</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.g-3</code> gutters),
      H5Div(["col themed-grid-col"><code>.col</code> with <code>.g-3</code> gutters),
  ...
  H5Div(["container" id="containers">
    <hr class="my-4">

    H5H2(["mt-4">Containers")
    H5P("Additional classes added in Bootstrap v4.4 allow containers that are 100% wide until a particular breakpoint. v5 adds a new <code>xxl</code> breakpoint.")
  ),
