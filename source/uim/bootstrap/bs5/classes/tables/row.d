...
@safe: class DBS5TableRow : DBS5Obj {
	...
	unittest {
		assert(Assert(BS5TableRow.th, `<tr><th></th></tr>`));
	}
	...
	unittest {
		assert(Assert(BS5TableRow.cell, `<tr><td></td></tr>`));
		assert(Assert(BS5TableRow.td, `<tr><td></td></tr>`));
	}
...
unittest {
	assert(Assert(BS5TableRow, "<tr></tr>"));
	//assert(Assert(BS5TableRow.values(["a","b"]), `<tr><td>a</td><td>b</td></tr>`));
}
