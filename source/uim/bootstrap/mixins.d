...
template BS4Func(string left, string right)
{
	...
	auto BS4" ~ left ~ "(string id, string[] classes) { return new DBS4"
		~ right ~ "(id, classes); }
	auto BS4" ~ left ~ "(string id, string[] classes, string content) { return new DBS4"
		~ right ~ "(id, classes, content); }
	auto BS4" ~ left
		~ "(string id, string[] classes, DH5Obj[] content...) { return new DBS4"
		~ right ~ "(id, classes, content); }

	auto BS4" ~ left
		~ "(string id, string[string] attributes) { return new DBS4" ~ right ~ "(id, attributes); }
	auto BS4" ~ left
		~ "(string id, string[string] attributes, string content) { return new DBS4"
		~ right ~ "(id, attributes, content); }
	auto BS4" ~ left
		~ "(string id, string[string] attributes, DH5Obj[] content...) { return new DBS4" ~ right ~ "(id, attributes, content); }

	auto BS4" ~ left
		~ "(string id, string[] classes, string[string] attributes) { return new DBS4"
		~ right ~ "(id, classes, attributes); }
	auto BS4" ~ left
		~ "(string id, string[] classes, string[string] attributes, string content) { return new DBS4" ~ right
		~ "(id, classes, attributes, content); }
	auto BS4"
		~ left
		~ "(string id, string[] classes, string[string] attributes, DH5Obj[] content...) { return new DBS4"
		~ right ~ "(id, classes, attributes, content); }

	auto BS4" ~ left ~ "(string[] classes) { return new DBS4"
		~ right ~ "(classes); }
	auto BS4" ~ left ~ "(string[] classes, string content) { return new DBS4"
		~ right ~ "(classes, content); }
	auto BS4" ~ left
		~ "(string[] classes, DH5Obj[] content...) { return new DBS4"
		~ right ~ "(classes, content); }

	auto BS4" ~ left ~ "(string[string] attributes) { return new DBS4" ~ right
		~ "(attributes); }
	auto BS4" ~ left ~ "(string[string] attributes, string content) { return new DBS4"
		~ right ~ "(attributes, content); }
	auto BS4" ~ left
		~ "(string[string] attributes, DH5Obj[] content...) { return new DBS4"
		~ right ~ "(attributes, content); }

	auto BS4" ~ left
		~ "(string[] classes, string[string] attributes) { return new DBS4" ~ right
		~ "(classes, attributes); }
	auto BS4" ~ left
		~ "(string[] classes, string[string] attributes, string content) { return new DBS4"
		~ right ~ "(classes, attributes, content); }
	auto BS4" ~ left
		~ "(string[] classes, string[string] attributes, DH5Obj[] content...) { return new DBS4"
		~ right ~ "(classes, attributes, content); }
	";
...
template BS4This(string bsName, string classes = null, string attributes = null)
{
	...
	this(string id, string[string] attributes) { super(id, attributes); ` ~ strClasses
		~ strAttributes ~ `}
	...
	this(string id, string[] someClasses, string[string] attributes) { super(id, someClasses, attributes); ` ~ strClasses
		~ strAttributes ~ `}
	...
	this(string[] someClasses) { super(someClasses); ` ~ strClasses
		~ strAttributes ~ `}
	...
	this(string[string] attributes) { super(attributes); ` ~ strClasses
		~ strAttributes ~ `}
	...
	this(string[] classes, string[string] attributes) { super(classes, attributes); ` ~ strClasses
		~ strAttributes ~ `}
