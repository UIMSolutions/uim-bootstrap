...
auto BS4"~name~"(DH5 content) { return new DBS4"~name~"(content); }
...
auto BS4"~name~"(string id, string[] classes, DH5 content) { return new DBS4"~name~"(id, classes, content); }
...
auto BS4"~name~"(string id, string[string] attributes, DH5 content) { return new DBS4"~name~"(id, attributes, content); }
...
auto BS4"~name~"(string id, string[] classes, string[string] attributes, DH5 content) { return new DBS4"~name~"(id, classes, attributes, content); }
...
auto BS4"~name~"(string[] classes, DH5 content) { return new DBS4"~name~"(classes, content); }
...
auto BS4"~name~"(string[string] attributes, DH5 content) { return new DBS4"~name~"(attributes, content); }
...
auto BS4"~name~"(string[] classes, string[string] attributes, DH5 content) { return new DBS4"~name~"(classes, attributes, content); }
";
}
...
template BS4Func(string left, string right)
{
	...
	auto BS4"~left~"(DH5 content) { return new DBS4"~right~"(content); }
	...
	auto BS4"~left~ "(string id, string[] classes, DH5 content) { return new DBS4"~right~"(id, classes, content); }
	...
	auto BS4"~left~"(string id, string[string] attributes, DH5 content) { return new DBS4" ~right~"(id, attributes, content); }
	...
	auto BS4"~left~"(string id, string[] classes, string[string] attributes, DH5 content) { return new DBS4"~right~"(id, classes, attributes, content); }
	...
	auto BS4"~left~"(string[] classes, DH5 content) { return new DBS4"~right~"(classes, content); }
	...
	auto BS4"~left~"(string[string] attributes, DH5 content) { return new DBS4"~right~"(attributes, content); }
	...
	auto BS4"~left~"(string[] classes, string[string] attributes, DH5 content) { return new DBS4"~right~"(classes, attributes, content); }
	";
}

template BS4This(string classes = null, string attributes = null) {
	...
	this(DH5 content) { super(content); `~strAddon~`}
	...
	this(string id, string[] someClasses, DH5 content) { super(id, someClasses, content); `~strAddon~`}
	...
	this(string id, string[string] attributes, DH5 content) { super(id, attributes).content(content); `~strAddon~`}
	...
	this(string id, string[] someClasses, string[string] attributes, DH5 content) { super(id, someClasses, attributes, content); `~strAddon~`}
	...
	this(string[] someClasses, DH5 content) { super(someClasses, content); `~strAddon~`}
	...
	this(string[string] attributes, DH5 content) { super(attributes, content); `~strAddon~`}
	...
	this(string[] classes, string[string] attributes, DH5 content) { super(classes, attributes, content); `~strAddon~`}
	`;
}
