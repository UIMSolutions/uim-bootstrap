...
class DBS4Nav : DBS4Obj {
	...
	O link(this O)(string url, string[] linkClasses, DHObj linkContent) { this.item(BS4NavLink(linkClasses, ["href":url], linkContent)); return cast(O)this; }
	...
	O link(this O)(string[] itemClasses, string url, DHObj[] linkContent...) { this.item(itemClasses, BS4NavLink(["href":url], linkContent)); return cast(O)this; }
	...
	O link(this O)(string[] itemClasses, string url, string[] linkClasses, DHObj[] linkContent...) { this.item(itemClasses, BS4NavLink(linkClasses, ["href":url], linkContent)); return cast(O)this; }
	unittest {
